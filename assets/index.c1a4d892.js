 ...
 */
{
  (function() {
    ...
    var updateHostText;
    {
      ...
      updateHostComponent = function(current2, workInProgress2, type2, newProps, rootContainerInstance) {
      ...
      switch (workInProgress2.tag) {
        ...
        case HostComponent: {
          ...
          if (current2 !== null && workInProgress2.stateNode != null) {
            updateHostComponent(current2, workInProgress2, type2, newProps, rootContainerInstance);
...
const base = "";
const main = "_main_1gza1_1";
const list = "_list_1gza1_5";
const listItem = "_listItem_1gza1_13";
const footer = "_footer_1gza1_17";
const header = "_header_1gza1_27";
const headerTitle = "_headerTitle_1gza1_31";
const headerBack = "_headerBack_1gza1_36";
const type = "_type_1gza1_40";
const pre = "_pre_1gza1_45";
const content = "_content_1gza1_49";
const link = "_link_1gza1_61";
const classes = {
  main,
  list,
  listItem,
...
var _jsxFileName = "/home/runner/work/scribble-analyser/scribble-analyser/src/dev.tsx";
client.createRoot(document.getElementById("root")).render(/* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(React.StrictMode, {
  children: /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(Main, {}, void 0, false, {
